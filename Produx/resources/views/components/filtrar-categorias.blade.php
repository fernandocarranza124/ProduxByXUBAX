<div class="px-2 px-0 py-2 md:py-10">
    ...
    <select x-cloak id="select">
        <option value="null" disabled selected>Todas las categorias</option>    
        @foreach ($rows as $row)
        <option value="{{$row->id}}">{{$row->nombre}}</option>    
        @endforeach
    </select>
    <label for="categorias" class="font-bold mb-1 text-gray-700 block">Categorias</label>
              ...
              <div x-on:click="open" class="w-full  svelte-1l8159u">
                  <div class="my-2 p-1 flex border border-gray-200 bg-white rounded svelte-1l8159u">
                      <div class="flex flex-auto flex-wrap">
                          ...
                          <div  class="flex">
                              <input id="categorias" placeholder="Selecciona una {{$titulo}}" hidden
