      ...
      <div class="relative sm:w-3/4 md:w-1/2 lg:w-1/3 mx-2 sm:mx-auto my-10 opacity-100">
        ...
        >
          <header class="flex flex-col justify-center items-center p-3 text-blue-600">
            <h2 class="font-semibold text-2xl">Agregar categoria</h2>
          </header>
            ...
            <div class="grid lg:grid-cols-1 gap-6">
              ...
              @csrf
                ...
                <div class="border focus-within:border-blue-500 focus-within:text-blue-500 transition-all duration-500 relative rounded p-1">
                  ...
                  <p>
                    <input id="nameCategoria" name="nameCategoria" autocomplete="false" tabindex="0" type="text" class="py-1 px-1 text-gray-900 outline-none block h-full w-full">
                  </p>
                </div>
                <br>
              </div>
            </main>
            <input type="text" name="" value="{{route('Categorias.store')}}" id="route" hidden="">
