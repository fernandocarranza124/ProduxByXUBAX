    ...
    <div x-data="app('{{$fechaActual}}')" x-init="[initDate(), getNoOfDays()]" x-cloak>
      <div class="container mx-auto px-0 py-2 md:py-10 px-2">
        <div class="mb-5 w-auto">
          ...
          <div class="relative">
            <input type="hidden" name="{{$id}}" x-ref="date" :value="datepickerValue" />
            <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="datepickerValue" x-on:keydown.escape="showDatepicker = false" class="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none text-gray-600 font-medium focus:ring focus:ring-blue-600 focus:ring-opacity-50" placeholder="Selecciona la {{$titulo}}" readonly />
